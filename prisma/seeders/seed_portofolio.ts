...
const myPortofolio: PortfolioItem[] = [
  {
    ...
    shortDesc:
      "Aplikasi ini adalah platform pemesanan tiket konser yang memudahkan pengguna untuk membeli dan memesan tiket ke konser favorit mereka. Dengan antarmuka yang intuitif dan fitur-fitur yang user-friendly, aplikasi ini memastikan proses pemesanan tiket menjadi cepat, mudah, dan aman.",
  ...
  },
  {
    ...
    shortDesc:
      "Aplikasi manajemen penyewaan laptop dirancang untuk mengelola proses penyewaan, pengembalian, inventaris, perawatan, pembayaran, dan pelaporan secara efisien, memastikan penyewaan laptop berjalan lancar dan transparan bagi pengguna.",
  ...
  },
  {
    ...
    techstack: laravelFullstackNonSPABootstrap,
    shortDesc:
      "Sistem informasi ini dirancang untuk mengelola data Pemuda MTA di Kabupaten Boyolali, mencakup data kepemudaan, guru daerah, dan anggota MTA Boyolali. Dengan sistem ini, pengelolaan informasi menjadi lebih terstruktur dan mudah diakses, sehingga mempermudah koordinasi dan administrasi internal organisasi.",
  ...
  },
  {
    ...
    techstack: [...php, ...jqueryBootstrap],
    shortDesc:
      "Sistem Informasi Terintegrasi untuk BBIB Singosari yang mana proyek ini juga diinisasi berkat tugas magang di PT Humma Teknologi Indonesia yang mana dikerjakan dengan PHP Native dan juga dengan template Sneat Bootstrap 5.",
  ...
  },
  {
    ...
    techstack: laravelFullstackNonSPABootstrap,
    shortDesc:
      "Sisfo PKL Hummatech adalah aplikasi yang dirancang untuk mempermudah pengelolaan Praktik Kerja Lapangan (PKL) di Hummatech. Aplikasi ini menyediakan fitur-fitur seperti pendaftaran peserta, monitoring, dan pelaporan hasil PKL.",
  ...
  },
  {
    ...
    techstack: laravelFullstackNonSPABootstrap,
    shortDesc:
      "Sistem ini adalah platform pemilihan ketua OSIS secara online yang dibangun dengan Laravel 8. Website ini memungkinkan siswa untuk memilih calon ketua OSIS dengan mudah dan transparan, serta dilengkapi dengan fitur keamanan untuk memastikan integritas proses pemilihan.",
  ...
  },
  {
    ...
    techstack: laravelFullstackNonSPABootstrap,
    shortDesc:
      "Proyek Humma E-Sport adalah platform e-sport yang dirancang khusus untuk menyediakan tempat dan menyelenggarakan berbagai ajang kompetisi e-sport. Platform ini dibangun menggunakan teknologi Laravel untuk backend yang kuat dan Bootstrap untuk antarmuka yang responsif dan menarik.",
  ...
  },
  {
    ...
    shortDesc:
      "Juara 🏆 #5 NIFC Universitas Muhammadiyah Riau 2024. Landing Page Museum Trinil adalah halaman utama yang dirancang untuk memberikan informasi lengkap tentang Museum Trinil. Halaman ini menampilkan sejarah museum, koleksi yang dimiliki, dan informasi kunjungan.",
  ...
  },
  {
    ...
    techstack: laravelFullstackNonSPABootstrap,
    shortDesc:
      "Landing Page Hummatech adalah halaman utama yang dirancang untuk menampilkan informasi tentang perusahaan teknologi Hummatech. Halaman ini berfungsi sebagai wajah online perusahaan, menampilkan layanan, produk, dan informasi kontak.",
  ...
  },
  {
    ...
    shortDesc:
      "Juara #3 🏆 Fostifest UMS Surakarta 2023, Visit Ngawi 2024 adalah landing page yang dirancang untuk mempromosikan destinasi wisata di Ngawi. Halaman ini menampilkan informasi lengkap tentang tempat-tempat wisata, acara, dan aktivitas yang dapat dinikmati pengunjung di Ngawi.",
  ...
  },
  {
    ...
    shortDesc:
      "Juara 🏆 #1 Intechfest 2020, Landing page tema kesehatan untuk Intechfest 2020, yang meraih juara pertama, adalah halaman web yang didesain khusus untuk memberikan informasi terkait tempat fasilitas kesehatan (faskes) dan bantuan medis dalam upaya mengurangi dampak COVID-19. Halaman ini mencakup peta lokasi faskes, informasi kontak penting, panduan kesehatan, dan sumber daya terkait COVID-19 seperti vaksinasi dan tes. Dengan desain yang responsif dan fokus pada kebutuhan pengguna, landing page ini bertujuan untuk memberikan akses cepat dan akurat terhadap informasi kesehatan yang penting selama pandemi.",
