...
// Mirrors the contract's WifiSpeed / CafePrice enums (no more
// @prisma/client-exported enum objects on Mongo — string literal unions).
type WifiSpeed = "WEAK" | "MEDIUM" | "STRONG";
type CafePrice = "CHEAP" | "MEDIUM" | "EXPENSIVE";
...
const coffeePlacesData: CoffeePlace[] = [
  {
    ...
    mapCoordinate: "-7.407694141624345, 111.46570697169916",
    mapUrl: "https://maps.app.goo.gl/bDB1DoQoiiWzwu7Q6",
  ...
  },
  {
    ...
    mapCoordinate: "-7.401118141102577, 111.44260554509965",
    mapUrl: "https://maps.app.goo.gl/veQPetconwQxxWaT9",
    image: imagePath("kopken-ngawi"),
    wifiProvider: "indibiz",
    parkFee: 2000,
    price: "MEDIUM",
    wifiSpeed: "MEDIUM",
    region: "Ngawi",
  ...
  },
  {
    ...
    mapCoordinate: "-6.289337935146352, 106.77823728743105",
    mapUrl: "https://maps.app.goo.gl/ssgT1bNwD797ShdMA",
  ...
  },
  {
    ...
    mapCoordinate: "-7.634867431544209, 111.51937105337524",
    mapUrl: "https://maps.app.goo.gl/UTayTrLyJbqb9x167",
  ...
  },
  {
    ...
    mapCoordinate: "-7.404721230883661, 111.4615439504678",
    mapUrl: "https://maps.app.goo.gl/NSEMj2r1KzbNLPFA8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.401708930975215, 111.44213703743462",
    mapUrl: "https://maps.app.goo.gl/EV6MEStDMbEUedzEA",
  ...
  },
  {
    ...
    mapCoordinate: "-7.404868320662563, 111.44049531386896",
    mapUrl: "https://maps.app.goo.gl/mFHi4V6NA3aHHcMm8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.408397476493666, 111.4421515691249",
    mapUrl: "https://maps.app.goo.gl/DuK2vPBqSJawYTni7",
  ...
  },
  {
    ...
    mapCoordinate: "-7.420078593519739, 111.44153738052064",
    mapUrl: "https://maps.app.goo.gl/Wfyd2EN5DwRRLmDV9",
    image: imagePath("thx"),
    parkFee: 0,
    price: "MEDIUM",
    wifiProvider: "telkom",
...

  {
    ...
    mapCoordinate: "-7.636885279376751, 111.53253765672265",
    mapUrl: "https://maps.app.goo.gl/c1962JA6Yv32Absb8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.63678717594058, 111.53988206582551",
    mapUrl: "https://maps.app.goo.gl/9EXqVzTGjjcttF637",
  ...
  },
  {
    ...
    mapCoordinate: "-7.636568780590796, 111.52380906969479",
    mapUrl: "https://maps.app.goo.gl/BmbTCvdSRCkXrnzAA",
  ...
  },
  {
    ...
    mapCoordinate: "-7.915055950552338, 112.59205980285974",
    mapUrl: "https://maps.app.goo.gl/GeMyCKSuLe3akSzt8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.947019659957446, 112.6133933353694",
    mapUrl: "https://maps.app.goo.gl/iQRcqcYjyTZAiDc67",
  ...
  },
  {
    ...
    mapCoordinate: "-7.912667124019404, 112.61938581487722",
    mapUrl: "https://maps.app.goo.gl/ZVRvAZateWPp72uq8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.962534571994624, 112.61528646943033",
    mapUrl: "https://maps.app.goo.gl/ZVRvAZateWPp72uq8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.94568223495749, 112.61961240771295",
    mapUrl: "https://maps.app.goo.gl/FbaA4hD5rUYSu3hy7",
  ...
  },
  {
    ...
    mapCoordinate: "-7.885407976176824, 112.66457997979296",
    mapUrl: "https://maps.app.goo.gl/NPhLaw7DmR9RKfdi8",
  ...
  },
  {
    ...
    mapCoordinate: "-7.926177311423704, 112.60539100204018",
    mapUrl: "https://maps.app.goo.gl/7VRdnnMG3ur2HWfj7",
  ...
  },
  {
    ...
    mapCoordinate: "-7.924402295940105, 112.60341239239271",
    mapUrl: "https://maps.app.goo.gl/tQ4tDSsBQ4L8WwGn6",
...

  {
    ...
    mapCoordinate: "-7.713044114964349, 110.59335567416215",
    mapUrl: "https://maps.app.goo.gl/kq36wfJNWy2g8xNx6",
...
async function seedCoffeePlaces() {
  ...
  for (const place of coffeePlacesData) {
    const now = new Date();
    const { image, recomended, open, close, ...rest } = place;
    await db.orm.coffee_places.create({
      ...rest,
      image: image ?? null,
