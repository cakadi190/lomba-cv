...
exports.getColorContrastText =
	exports.hslToRgb =
	exports.rgbToHsl =
	exports.rgbToHex =
	exports.hexToRgb =
	exports.getRandomRGBAColor =
 ...
 */
var rgbToHex = (r, g, b) =>
	"#".concat(((1 << 24) + (r << 16) + (g << 8) + b).toString(16).slice(1));
...
var hslToRgb = (h, s, l) => {
	...
	return "rgb("
		...
		.concat(Math.round(g * 255), ", ")
		.concat(Math.round(b * 255), ")");
};
 ...
 */
var getColorContrastText = (hexColor, white, black) => {
	if (white === void 0) {
		white = "#fff";
	}
	if (black === void 0) {
