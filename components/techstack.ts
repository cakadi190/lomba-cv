const jqueryBootstrap = ["devicon:jquery", "devicon:bootstrap"];

const reactjs = ["devicon:react", "devicon:javascript"];
...
const flutterDart = ["devicon:flutter", "devicon:dart"];

const htmlCssJS = ["devicon:html5", "devicon:css3", "devicon:javascript"];

const vuejs = ["devicon:vuejs", "devicon:javascript"];

const vuets = ["devicon:vuejs", "devicon:typescript", "devicon:javascript"];

const nuxt = ["devicon:nuxtjs", ...vuejs];

const tailwind = ["devicon:tailwindcss", ...htmlCssJS];

const tailwindAlpine = [...tailwind, "devicon:alpinejs"];

const php = ["devicon:php"];
